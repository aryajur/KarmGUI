...
If you are running wxlua on the Mac you can support the Mac version for Karm by sending me the wxluafreeze executable. I can then create a Karm executable for Mac and include it in the distribution.


LICENSE
Karm is released under MIT license. Please see the LICENSE.txt file in this distribution for the License.
